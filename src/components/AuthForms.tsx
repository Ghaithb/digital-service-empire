...
export const SocialAuthButton: React.FC<{
    ...
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 gap-3">
          <SocialAuthButton provider="google" apiUrl={apiUrl} />
          <SocialAuthButton provider="facebook" apiUrl={apiUrl} />
          <SocialAuthButton provider="apple" apiUrl={apiUrl} />
        </div>
      </CardContent>
    </Card>
  );
